...
import SebastianHeadshot from '../../../assets/images/headshots/SebastianHeadshot-min.jpg';
import CadenHeadshot from '../../../assets/images/headshots/CadenHeadshot-min.jpg';
...
export default () => {
	...
	return (
		<div className='flex flex-col  gap-10 my-10 w-full items-center justify-center'>
			<div className='flex flex-col sm:flex-row gap-24 sm:gap-10 justify-center items-center w-4/5'>
					...
					<div className='flex flex-col gap-10 items-center'>
						...
						<div className='flex flex-col gap-2 w-full'>
							<p className='w-full text-center sm:text-left'>
								Sebastian has published an opinion piece in the
								LA Times and been featured on TV with the
								objective of pushing for more SAT availability.
								He is the founder of TestAccess and is a student
				...
				<div className='flex flex-col order-first sm:order-none text-center gap-10 sm:mb-52 sm:pb-5 pb-0'>
					<h1 className='text-2xl sm:text-4xl text-nowrap'>
						Who are we?
					</h1>
					<p className='text-wrap' ref={WhoAreWeRef}>
						TestAccess is a student-led organization dedicated to
						increasing standardized testing availability in
						California.
					</p>
					<Link to='/our-mission'>
				...
				<div
					...
					<div className='flex flex-col gap-10'>
						...
						<div className='flex flex-col gap-2 w-full'>
							<p className='w-full text-center sm:text-left'>
								Caden is a software engineer and a student at
								Tamalpais High School, and is the developer of
								TestAccess. He is crucial in TestAccess's
								mission of widening SAT availability in
								California.
							</p>
						</div>
					</div>
